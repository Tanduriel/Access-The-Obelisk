...
namespace AccessTheObelisk
{
    ...
    public static class Loc
    {
        ...
        {
            En.Clear();
            En["mod_loaded"] = "AccessTheObelisk v0.1.9.";
            ...
            En["hero_selection_controls"] = "Up and Down switch between party slots, heroes, and actions. Left and Right move within the current section. Control plus Left and Control plus Right switch hero detail buffers. Control plus Up and Control plus Down read hero details. Press Enter on a party slot to choose the target slot. Press Enter on a hero to assign that hero to the target slot. Press Control plus Enter on a hero or filled party slot to open that hero's perk tree.";
            ...
            En["settings_alert_choice"] = "Selected: {0}. Left and Right choose. Enter confirms.";
            ...
            En["deck_controls"] = "Up and Down move between cards. Control plus Up and Control plus Down read details. Enter opens the card detail screen. Escape closes the deck. F opens the deck or combat draw pile. Shift plus F opens the combat discard pile.";
